...
const UserProfile = () => {
    ...
    return (
        <div className="bg-gradient-to-t from-teal-50 to-teal-100 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-screen-xl mx-auto">
                {/* Profile Header */}
                <div className="relative rounded-2xl shadow-lg overflow-hidden mb-12">
                    <div className="w-full h-64 bg-gradient-to-r from-teal-500 to-cyan-400 absolute top-0 left-0 z-0" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 transition-transform transform hover:scale-105 hover:shadow-xl">
                        <h2 className="text-2xl font-semibold text-teal-600 mb-4">Personal Information</h2>
                    ...
                    {/* Stats Card */}
                    <div className="bg-white rounded-2xl shadow-lg p-6 transition-transform transform hover:scale-105 hover:shadow-xl">
                        <h2 className="text-2xl font-semibold text-teal-600 mb-4">Statistics</h2>
                        <div className="space-y-4">
                            <div className="flex justify-between text-teal-700">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 transition-transform transform hover:scale-105 hover:shadow-xl lg:col-span-2">
                        <h2 className="text-2xl font-semibold text-teal-600 mb-4">Recent Posts</h2>
                            ...
                            {articles && articles.length > 0 ? (
                                articles.map((post, index) => (
                                    <li key={index} className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-teal-600">{post.title}</p>
