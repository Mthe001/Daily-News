...
const MyArticles = () => {
    ...
    return (
        <div className="pt-10">
            <Helmet>
                <title>My Articles || News 240</title>
            </Helmet>
            {isLoading
                ?
                                    ...
                                    <tr key={article._id}>
                                        ...
                                        <td className="flex items-center justify-start gap-10">
                                            ...
                                            <Link to={`/update-article/${article?._id}`}>
                                                <Button
                                                    size="sm"
                                                    className="rounded-md  bg-green-500 hover:bg-green-600 text-sm font-medium text-black focus:outline-none"
                                                >
                                                    <CiEdit></CiEdit>
                                                </Button>
                                            </Link>
                                            ...
                                            <Button className='bg-red-500 hover:bg-red-600' onClick={() => handleDelete(article._id)} size="sm"> <TiDeleteOutline></TiDeleteOutline> </Button>
                                        </td>
