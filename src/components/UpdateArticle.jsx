...
import animationData from './path-to-your-lottie-file.json'; // Replace with the correct path to your Lottie animation
...
const UpdateArticleForm = ({
    ...
    return (
        <div className="flex items-center justify-center my-20 bg-blue-50 py-10">
            <Helmet>
                <title>Update Article ! News 240</title>
            </Helmet>
            <div className="md:w-11/12 lg:w-9/12 flex flex-col-reverse md:flex-row bg-blue-500 text-white shadow-lg rounded-lg">
                {/* Form Section */}
                <div className="md:w-3/6 p-6">
                    <h1 className="text-3xl font-bold mb-6">Update an Article</h1>
                    <form onSubmit={handleUpdate} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={formData.title}
                                onChange={handleInputChange}
                                className="w-full p-3 border border-blue-300 rounded focus:outline-none focus:ring-2 focus:ring-white"
                                required
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-white text-blue-500 py-3 rounded hover:bg-blue-200 transition duration-200"
                        >
                            Submit
                        </button>
                    </form>
                ...
                <div className="md:w-3/6 p-6 flex items-center justify-center bg-blue-600 rounded-r-lg">
