    ...
    return (
        <section className={`plans-section ${pathname === "/" ? "pt-24" : "pt-0"} pb-10 my-6 bg-background rounded-lg border-2 mx-10`}>
            <div className="md:w-11/12 w-full flex flex-col items-center justify-center p-8 rounded-xl mx-auto text-center">
                <h2 className="lg:text-5xl md:text-4xl  text-xl text-start lg:text-center font-semibold text-gray-900 dark:text-white mb-8">
                    Unlock Premium Benefits: Your Pathway to Exclusive Content Awaits
                </h2>
                <p className="text-md text-start text-gray-600 dark:text-gray-400 mb-12">
                    ...
                    {[
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between  w-full mb-4 relative z-10">
                                <h3 className="lg:text-xl text-sm font-semibold text-gray-900 dark:text-white">{plan.title}</h3>
                                <div className="text-right">
                                    <span className="lg:text-3xl md:text-3xl text-xl font-bold text-gray-900 dark:text-white">${plan.price}</span>
                                    <span className="text-sm text-gray-600 dark:text-gray-300">/mo</span>
                                </div>
                            </div>
                            <p className="text-gray-700 lg:text-xl lg:text-center text-sm text-start dark:text-gray-200 mb-6 relative z-10">{plan.description}</p>
                            <ul className="text-gray-600 dark:text-gray-300 space-y-3 lg:text-xl text-sm   mb-6 relative z-10">
